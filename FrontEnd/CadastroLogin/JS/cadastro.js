...
function setupFormSubmission() {
  ...
  registerForm.addEventListener("submit", async function (e) {
    ...
    try {
      await axios.post("https://senaicommunitydeploy2.onrender.com/cadastro/alunos", formData, {
...
function handleCredentialResponse(response) {
  ...
  axios
    .post("https://senaicommunitydeploy2.onrender.com/autenticacao/login/google", {
